// document-id.js — stable document ID generation and markdown utilities
//
// Document IDs are sha256(siteId + ':' + relPath).slice(0, 32).
// Frontmatter can override this with an `id` field (see makeDocumentId).
